...
public class Comunas {
	...
	public Map<Integer, Poligono> inicializarHashComunas() {
		...
		hashComunas.put(1,
				new Poligono(Arrays.asList(new Point(-34.5684496, -58.3836877), new Point(-34.599593, -58.392975),
		...
		hashComunas.put(2,
				new Poligono(Arrays.asList(new Point(-34.569949, -58.399233), new Point(-34.573236, -58.401832),
		...
		hashComunas.put(3,
				new Poligono(Arrays.asList(new Point(-34.620654, -58.412508), new Point(-34.608184, -58.414697),
						new Point(-34.598018, -58.411890), new Point(-34.599638, -58.392959),
						new Point(-34.618135, -58.391683))));

		hashComunas.put(4, new Poligono(Arrays.asList(new Point(-34.662045, -58.424107),
		...
		hashComunas.put(5,
				new Poligono(Arrays.asList(new Point(-34.640147, -58.423472), new Point(-34.615428, -58.430077),
		...
		hashComunas.put(6,
				new Poligono(Arrays.asList(new Point(-34.630569, -58.451597), new Point(-34.626826, -58.426878),
		...
		hashComunas.put(7,
				new Poligono(Arrays.asList(new Point(-34.622367, -58.477772), new Point(-34.613932, -58.459477),
		...
		hashComunas.put(8,
				new Poligono(Arrays.asList(new Point(-34.705011, -58.461450), new Point(-34.662240, -58.424200),
		...
		hashComunas.put(9, new Poligono(Arrays.asList(new Point(-34.634553, -58.530041),
		...
		hashComunas.put(10,
				new Poligono(Arrays.asList(new Point(-34.634738, -58.530290), new Point(-34.611219, -58.529371),
		...
		hashComunas.put(11,
				new Poligono(Arrays.asList(new Point(-34.581145, -58.515432), new Point(-34.594714, -58.502726),
		...
		hashComunas.put(12,
				new Poligono(Arrays.asList(new Point(-34.581205, -58.515301), new Point(-34.549705, -58.500722),
		...
		hashComunas.put(13,
				new Poligono(Arrays.asList(new Point(-34.583122, -58.444426), new Point(-34.578525, -58.439996),
		...
		hashComunas.put(14,
				new Poligono(Arrays.asList(new Point(-34.597597, -58.416041), new Point(-34.583465, -58.406256),
		...
		hashComunas.put(15,
				new Poligono(Arrays.asList(new Point(-34.572384, -58.467278), new Point(-34.583178, -58.444458),
